...
def gera_tabela_escolaridade(path_data, ini_ano=2018, fim_ano=2022, path_save="../../data/tabela_escolaridade.csv"):
    """
    ...
    >>> gera_tabela_escolaridade(path_data="../../data/", ini_ano=1997, fim_ano=2004)
